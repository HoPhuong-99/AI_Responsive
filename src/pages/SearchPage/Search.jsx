  ...
  return (
    <>
      {listDataSearch?.length ? (
        ...
        <div className={style.search_emty}>
          <div className={style.wrap_search_emty}>
            <h2 className={style.title_search_emty}>TÌM KIẾM</h2>
            <span>
              <svg
                width="132"
                height="170"
            ...
            <h3 className={style.subtitle_search_emty}>
              Không tìm thấy nội dung bạn yêu cầu
            </h3>
            <span className={style.dec_search_emty}>
              Không tìm thấy "sadadwaf". Vui lòng kiểm tra chính tả, sử dụng các
              từ tổng quát hơn và thử lại!
            </span>
          </div>
        </div>
      )}
